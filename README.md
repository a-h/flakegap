...
If you want to export packages from package managers like PyPi (Python) or NPM (Node.js), use the https://github.com/a-h/depot project to pull the packages, and upload them to a depot instance.
